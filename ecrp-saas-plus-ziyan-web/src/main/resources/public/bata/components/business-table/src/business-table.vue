...
<!--          <template scope="scope">
            {{column.html}}
           &lt;!&ndash;{{scope.row.date}} 12:32:53&ndash;&gt;
            <div v-html="column.html"></div>
          </template>-->
          <!--<template scope="scope"  v-if="column.html !== undefined">-->
            <!--<column-cell-content :data-method="column.html"></column-cell-content>-->
          <!--</template>-->
        </el-table-column>
      </template>
      <!-- 预留标签 模板配置 -->
...
<script>
import busMultiFilter from '../src/business-multi-filter.vue'
export default {
...
/*    tableParam: {
  ...
  components: {
    ...
    columnCellContent: {
      ...
      render (h) {
        const columenData = this.columnParam
        return (this.dataMethod(h, {columenData}))
//        return h('div', {
//          'class': ['render-box', 'bg'],
//          domProps: {
//            innerHTML: 'baz'
