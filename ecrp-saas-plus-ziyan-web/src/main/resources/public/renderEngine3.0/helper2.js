	...
	var table_mixin = {
		...
		methods: {
			...
			$handleCollapseClick: function() {
				...
				function toBinary(expand, searched, showCondition) {
					return Number(`0b${expand ? 1 : 0}${searched ? 1 : 0}${showCondition ? 1 : 0}`);
				}
				var result = toBinary(expand, searched, showCondition);
				...
				switch(result) {
					...
					case 4: 
						...
						break;
					case 6:
						this._data._queryConfig.showCondition = true; 
						break;
					case 7: 
				...
				/*
				if(this._data._queryConfig.searched == false && this._data._queryConfig.expand == false) {
					this._data._queryConfig.expand = true;
				} else if(this._data._queryConfig.searched == true && this._data._queryConfig.expand == false) {
					this._data._queryConfig.expand = true;
				} else  if(this._data._queryConfig.searched == false && this._data._queryConfig.expand == true) {
					this._data._queryConfig.expand = true;
				} else if(this._data._queryConfig.searched == true && this._data._queryConfig.expand == true 
						&& this._data._queryConfig.showCondition == false) {
					this._data._queryConfig.showCondition = true;
				} else if(this._data._queryConfig.searched == true && this._data._queryConfig.expand == true 
						&& this._data._queryConfig.showCondition == true) {
