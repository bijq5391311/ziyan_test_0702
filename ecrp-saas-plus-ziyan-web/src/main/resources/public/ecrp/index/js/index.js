require([ "vue", "nui", "jquery","/public/bata/extensions/vue-echarts/vue-echarts.js","/public/ecrp/index/js/popover.js","utilbuild/main"],
		function(Vue, Nui, $,businessEcharts,businessPopoverSelect) {
	new Vue({
		  el: '#app',
		  components: {
		    // xeWidget,
		    // customerOverview,
		    "business-echarts": businessEcharts,
		    "business-popover-select": businessPopoverSelect
