//最小单次购买数量
var min_single_buy_num = {
	Data : function(param1,param){
			param = "min_single_buy_num";
			var getValue ={};
        	getValue.relation = "";
	...
	Sql : function (param){
			...
			for (var i = data.length-1; i >= 0; i--) {
				...
				getSqlCondition += " "+data[i].relation+" kd_customer_shop_rfm.min_single_buy_num  "+data[i].condition+" '"+data[i].CDATA+"'";
			}
