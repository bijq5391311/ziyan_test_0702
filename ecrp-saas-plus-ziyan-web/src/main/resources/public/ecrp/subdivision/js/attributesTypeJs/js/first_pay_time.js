...
var first_pay_time = {
	...
	Sql : function (param){
			...
			for (var i = data.length-1; i >= 0; i--) {
                ...
                getSqlCondition += " "+data[i].relation+" DATE_FORMAT(kd_customer_shop_rfm.first_pay_time,'%Y-%m-%d') "+data[i].condition+" '"+data[i].date+"'";
			}
