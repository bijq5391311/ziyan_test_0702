//最大单次购买金额
var max_single_buy_amount = {
	Data : function(param1,param){
			param = "max_single_buy_amount";
			var getValue ={};
        	getValue.relation = "";
	...
	Sql : function (param){
			var name = "max_single_buy_amount";
			...
			for (var i = data.length-1; i >= 0; i--) {
				...
				getSqlCondition += " "+data[i].relation+" kd_customer_shop_rfm.max_single_buy_amount  "+data[i].condition+" '"+data[i].CDATA+"'";
			}
