//首次下单时间
var first_order_time = {
	Data : function(param1,param){
			param = "first_order_time";
			var getValue ={};
        	getValue.relation = "";
	...
	Sql : function (param){
        ...
        for (var i = data.length-1; i >= 0; i--) {
            ...
            getSqlCondition += " "+data[i].relation+" DATE_FORMAT(kd_customer_shop_rfm.first_order_time,'%Y-%m-%d') "+data[i].condition+" '"+data[i].date+"'";
        }
