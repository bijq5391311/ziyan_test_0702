...
@Authorize
@Controller("/integral/kdpointrule")
@RequestMapping("/integral/kdpointrule")
public class ZyIntegralController extends BaseController {
	@Authorize(order = 0)
	public void zyPointRuleList() {
	}
	...
	public CommonResult initPointRule() {
		...
		// 根据渠道获取渠道信息
		ZySysShop sysShop = ZySysShop.dao().loadSysShop("线下门店", SystemConstat.STATE_1, SystemConstat.STATE_0);
		if (null != sysShop) {
